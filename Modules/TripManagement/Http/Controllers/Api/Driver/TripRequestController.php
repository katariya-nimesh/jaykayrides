...
class TripRequestController extends Controller
{
    ...
    public function pendingRideList(Request $request): JsonResponse
    {
        ...
        // check driver minimum balance
        $driverMinimumBalance = UserAccount::where('user_id', $user->id)->first();
        if (!$driverMinimumBalance || $driverMinimumBalance->wallet_balance <= 5) { // Minimum balance required
            return response()->json(responseFormatter(constant: DEFAULT_200, content: ''));
        }
