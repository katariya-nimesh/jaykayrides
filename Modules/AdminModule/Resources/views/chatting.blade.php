            ...
            <div class="col-xl-3 col-lg-4 chatSel">
                <div class="card card-body px-0 h-100">
                    ...
                    <div id="chatting-drivers-list">
                        @include('adminmodule::partials._chatting-search-drivers')
                    </div>
                </div>
            </div>
        ...
        <div class="offcanvas offcanvas-end" id="filter-offcanvas">
            ...
            <div class="offcanvas-body scrollbar-thin">
                ...
                <div id="savedTopicAnswer" class="mt-2">
                    @include('adminmodule::chatting-saved-answer')
                </div>
            </div>
        </div>
    @endif
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.chatting-drivers-list-search').on('keyup', function () {
                ...
                $.ajax({
                    url: '{{ route('admin.search-drivers') }}',
                    type: 'GET',
                    data: {
                        search: value
                    },
                    success: function (response) {
                        $('#chatting-drivers-list').html('');
                        $('#chatting-drivers-list').html(response);
                        conversation();
