                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <ol class="d-flex flex-column text-dark gap-1">
                                    <li>{{translate("To get OAuth Client ID Go to the Credentials page")}} ( <a href="https://www.google.com/recaptcha/admin/create" target="_blank"><b>{{translate("click_here")}}</b></a> )
                                    </li>
                                    <li>{{translate("Click Create Credentials")}} &gt; <b>{{translate("OAuth Client ID")}}</b></li>
                                    <li>{{translate("Select")}} <b>{{translate("Web application")}}</b> {{translate("Type")}}</li>
                                    <li>{{translate("Name your OAuth 2.0 client")}}</li>
                                    <li>{{translate("Click")}} <b>{{translate("ADD URI")}}</b> {{translate("From")}} <b>{{translate("Authorized redirect URIs")}}</b></li>
                                    <li>{{translate("Provide the callback URI from below and click create")}}</li>
                                    <li>{{translate("Press Submit")}}</li>
                                    <li>{{translate("Copy Client ID")}} &amp; {{translate("Client Secrete and Paste in the input filed beside and
                                        Save.")}}
                                    </li>
                                </ol>
